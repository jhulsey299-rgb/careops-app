...
const curriculum = [
  {
    ...
    title: "Foundations",
    description: "SQL Foundations for Hospital Data",
    order: 1,
    categories: [
      {
        id: "foundations_core",
        ...
        lessons: [
          {
            ...
            bullets: [
              "Use it to explore a dataset quickly.",
              "Use it to validate available fields before narrowing your query.",
              "Avoid using it carelessly in large production queries."
            ],
            example: "Example: SELECT * FROM patients;",
          ...
          },
          {
            ...
            objective: "Retrieve all patient records from the patients table.",
            sql_focus: ["SELECT"],
            relevantTables: ["patients"],
          ...
          },
          {
            ...
            objective: "Understand how the WHERE clause filters records.",
            sql_focus: ["WHERE"],
            relevantTables: ["encounters"],
            joinHint: "No join is needed for this lesson.",
            summary: "The WHERE clause filters records.",
            bullets: [
              "Use WHERE to narrow the data to the population you care about.",
              "Filtering is critical for identifying high-risk patients and operational issues.",
              "Apply filters before grouping when you need to isolate a cohort."
            ],
            example: "Example: SELECT * FROM encounters WHERE length_of_stay > 5;",
            executiveTakeaway: { show: false }
          },
          {
            kind: "challenge",
            ...
            objective: "Filter encounter records with long length of stay.",
            sql_focus: ["SELECT", "WHERE"],
            relevantTables: ["encounters"],
          ...
          },
          {
            ...
            bullets: [
              "Sorting helps you identify top drivers and prioritize review.",
              "Descending order is useful for surfacing the largest values first.",
              "Sorted results are easier to communicate to operations leaders."
            ],
            example: "Example: SELECT * FROM encounters ORDER BY length_of_stay DESC;",
            executiveTakeaway: { show: false }
          },
          {
            kind: "challenge",
            ...
            objective: "Sort encounter records by length_of_stay descending.",
            sql_focus: ["SELECT", "ORDER BY"],
            relevantTables: ["encounters"],
            joinHint: "Use only the encounters table for this lesson.",
  ...
  },
  {
    id: "track_core",
    title: "Core",
    description: "Core Hospital Analytics",
    order: 2,
    categories: [
      {
        ...
        lessons: [
          {
            ...
            bullets: [
              "Use COUNT(*) to measure total rows in a table or filtered dataset.",
              "In healthcare this supports encounter volume, workload, and utilization reporting.",
              "Count measures are foundational for operations, finance, and capacity planning."
            ],
            example: "Example: SELECT COUNT(*) FROM encounters;",
            executiveTakeaway: { show: false }
          },
          {
            kind: "challenge",
            ...
            objective: "Measure total encounter volume.",
            sql_focus: ["COUNT"],
            relevantTables: ["encounters"],
            joinHint: "Use only the encounters table for this lesson.",
          ...
          },
          {
            ...
            bullets: [
              "Use GROUP BY to compare performance across units.",
              "Grouping is how analysts move from one total to segmented insights.",
              "It is commonly used for department, payer, provider, and facility reporting."
            ],
            example: "Example: SELECT department_id, COUNT(*) FROM encounters GROUP BY department_id;",
            executiveTakeaway: { show: false }
          },
          {
            kind: "challenge",
          ...
          },
          {
            ...
            bullets: [
              "Average metrics are used to measure efficiency and performance.",
              "Average length of stay is a common throughput metric.",
              "Averages are most useful when paired with segmentation and operational context."
            ],
            example: "Example: SELECT AVG(length_of_stay) FROM encounters;",
            executiveTakeaway: { show: false }
          },
          {
            kind: "challenge",
            ...
            smartHint: "AVG(length_of_stay) with alias avg_los.",
          ...
          },
          {
            ...
            objective: "Interpret a department-level LOS pattern and recommend the right next step.",
            relevantTables: ["encounters"],
            joinHint: "Think about what data would explain why LOS is higher in one department.",
            summary: "One department has significantly higher LOS than others.",
            prompt: "You ran a query showing that one department has significantly higher LOS than others. Explain the most appropriate next step. In your response, mention workflow delays, case complexity, or discharge barriers and explain why averaging or ignoring the result would be a mistake.",
  ...
  },
  {
    id: "track_applied",
    title: "Applied",
    description: "Applied Analytics: Trends & Investigation",
    order: 3,
    categories: [
      {
        ...
        lessons: [
          {
            ...
            objective: "Rank departments by encounter volume.",
            sql_focus: ["COUNT", "GROUP BY", "ORDER BY", "LIMIT"],
            relevantTables: ["encounters"],
            joinHint: "Use only the encounters table for this lesson.",
            ...
            hint: "Group by department and count encounters.",
            smartHint: "Use COUNT(*) and ORDER BY descending.",
            thirdHint: "SELECT department_id, COUNT(*) AS encounter_count FROM encounters GROUP BY department_id ORDER BY encounter_count DESC LIMIT 5;",
          ...
          },
          {
            ...
            objective: "Find patients with frequent encounters.",
            sql_focus: ["COUNT", "GROUP BY", "HAVING"],
            relevantTables: ["encounters"],
            joinHint: "Use only the encounters table for this lesson.",
            ...
            hint: "Group encounters by patient.",
            smartHint: "Use HAVING COUNT(*) > 3.",
          ...
          },
          {
            ...
            objective: "Compare department efficiency using average LOS.",
            sql_focus: ["AVG", "GROUP BY", "ORDER BY"],
            relevantTables: ["encounters"],
            joinHint: "Use only the encounters table for this lesson.",
            challengeCriteria: `Leadership wants to compare efficiency across departments.\n\nReturn department_id and average LOS.\nSort from highest to lowest LOS.\n\nThis helps identify departments with potential inefficiencies.`,
            ...
            hint: "Use AVG and group by department.",
            smartHint: "Sort results by avg_los descending.",
            thirdHint: "SELECT department_id, AVG(length_of_stay) AS avg_los FROM encounters GROUP BY department_id ORDER BY avg_los DESC;",
          ...
          },
          {
            ...
            objective: "Interpret a spike in department LOS and recommend the next step.",
            relevantTables: ["encounters"],
            joinHint: "Think about case mix, staffing, and discharge barriers.",
            summary: "One department's LOS increased significantly this month.",
            prompt: "You discover that one department’s LOS increased significantly this month. Explain the best next step. Mention patient mix, staffing constraints, or discharge delays and explain why ignoring the increase or averaging it away would be a mistake.",
            expectedKeywords: ["patient", "mix", "staffing", "discharge", "delay", "investigate"],
            minLength: 80,
            minimumKeywordMatches: 2,
            feedbackGuide: "A strong answer focuses on investigating the operational or clinical drivers behind the spike rather than masking it in summary reporting.",
            executiveTakeaway: { show: false }
          }
        ]
      }
  ...
  },
  {
    id: "track_advanced",
    title: "Advanced",
    description: "Diagnosis: Root Cause Analysis",
    order: 4,
    categories: [
      {
        id: "diagnosis_root_cause_analysis",
        ...
        lessons: [
          {
            ...
            smartHint: "Group by payer.",
            thirdHint: "SELECT c.payer, AVG(e.length_of_stay) AS avg_los FROM encounters e JOIN claims c ON e.encounter_id = c.encounter_id GROUP BY c.payer;",
          ...
          },
          {
            ...
            objective: "Identify departments driving readmissions.",
            sql_focus: ["JOIN", "COUNT", "GROUP BY"],
            relevantTables: ["readmissions", "encounters"],
            joinHint: "Use readmit_encounter_id to join readmissions to encounters.",
            ...
            smartHint: "Group by department_id.",
            thirdHint: "SELECT e.department_id, COUNT(*) AS readmit_count FROM readmissions r JOIN encounters e ON r.readmit_encounter_id = e.encounter_id GROUP BY e.department_id;",
          ...
          },
          {
            ...
            smartHint: "Sum billed_amount for denied claims.",
            thirdHint: "SELECT payer, SUM(billed_amount) AS denied_total FROM claims WHERE claim_status = 'Denied' GROUP BY payer;",
          ...
          },
          {
            ...
            objective: "Recommend the next step after finding high readmissions in one department.",
            relevantTables: ["readmissions", "encounters"],
            joinHint: "Think about discharge process, care transitions, and follow-up.",
            summary: "Readmissions are highest in one department.",
            prompt: "You find that readmissions are highest in one department. Explain the most appropriate next step. Mention discharge process, follow-up care, or care transitions and explain why ignoring or blaming the data would be a poor response.",
            expectedKeywords: ["discharge", "follow-up", "transition", "process", "investigate"],
            minLength: 80,
            minimumKeywordMatches: 2,
            feedbackGuide: "A strong answer focuses on operational and care-transition root causes rather than dismissing the signal.",
            executiveTakeaway: { show: false }
          }
        ]
      }
  ...
  },
  {
    id: "track_expert",
    title: "Expert",
    description: "Executive Analytics & Decision Making",
    order: 5,
    categories: [
      {
        id: "executive_analytics_and_decision_making",
        ...
        lessons: [
          {
            ...
            objective: "Prioritize the operational issue leadership should address first.",
            relevantTables: ["encounters", "readmissions"],
            joinHint: "Consider the combined impact of LOS and readmissions on operations.",
            summary: "LOS is rising, readmissions are increasing, and volume is stable.",
            prompt: "Your analysis shows that LOS is rising, readmissions are increasing, and volume is stable. Explain what leadership should prioritize first and why. Mention discharge efficiency or care transitions in your response.",
            expectedKeywords: ["discharge", "efficiency", "care", "transition", "priority"],
            minLength: 80,
            minimumKeywordMatches: 2,
            feedbackGuide: "A strong answer identifies discharge efficiency and care transitions as the priority because LOS and readmissions are worsening together while volume is stable.",
            executiveTakeaway: { show: false }
          },
          {
            kind: "scenario",
            ...
            objective: "Frame operational insights for leadership.",
            relevantTables: ["encounters"],
            joinHint: "Focus on the issue, likely cause, and next action.",
            summary: "One department has a notably high LOS.",
            prompt: "You ran an analysis showing high LOS in one department. Write a short executive summary that includes the key issue, likely cause, and recommended next step.",
            expectedKeywords: ["issue", "cause", "recommend", "action", "delay"],
            minLength: 90,
            minimumKeywordMatches: 2,
            feedbackGuide: "A strong answer clearly states the issue, identifies a likely operational driver, and recommends a specific next step for leadership.",
            executiveTakeaway: { show: false }
          },
          {
            kind: "scenario",
            ...
            objective: "Choose which issue leadership should prioritize.",
            relevantTables: ["claims", "encounters"],
            joinHint: "Compare operational severity and organizational impact.",
            summary: "You identify moderate denial issues, severe LOS issues, and minor volume fluctuation.",
            prompt: "You identify moderate denial issues, severe LOS issues, and minor volume fluctuation. Explain what should be prioritized and why. Mention capacity, cost, or patient outcomes in your response.",
            expectedKeywords: ["los", "capacity", "cost", "outcomes", "priority"],
            minLength: 80,
            minimumKeywordMatches: 2,
            feedbackGuide: "A strong answer prioritizes LOS because of its broad operational, financial, and patient-care impact.",
            executiveTakeaway: { show: false }
          },
          {
            kind: "scenario",
            ...
            objective: "Recommend the best next action for a department with high LOS.",
            relevantTables: ["encounters", "discharges"],
            joinHint: "Think about discharge delays and workflow bottlenecks.",
            summary: "LOS is high in one department.",
            prompt: "LOS is high in one department. Explain the best next action leadership should take. Mention discharge delays or workflow bottlenecks and explain why action planning matters.",
            expectedKeywords: ["discharge", "workflow", "bottleneck", "action", "investigate"],
            minLength: 80,
            minimumKeywordMatches: 2,
            feedbackGuide: "A strong answer emphasizes targeted investigation into discharge delays and workflow constraints so analytics can drive operational improvement.",
            executiveTakeaway: { show: false }
          }
        ]
      }
